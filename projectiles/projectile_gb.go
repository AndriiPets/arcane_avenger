...
func (p *ProjectileGB) Update() {
	...
	//sine pattern
	yOffset := p.Amplitude * math.Cos(2*math.Pi*p.Frequency*p.Time+p.Phase)
	py += yOffset
...
func (p *ProjectileGB) Draw(screen *ebiten.Image) {
...
func (p *ProjectileGB) spawn_add_projectiles() {
...
func (p *ProjectileGB) IsAlive() bool {
	return p.Alive
}

func (p *ProjectileGB) GetObject() *resolv.Object {
	return p.Object
}
