...
func SpawnProjectileRGB(space *resolv.Space, position resolv.Vector, direction resolv.Vector, color color.RGBA, size float64) *ProjectileRGB {
	...
	p.Particle = particles.NewParticleSpawner(p.Object, p.Color, "stroke_circle", false)
...
func (p *ProjectileRGB) Draw(screen *ebiten.Image) {
...
func (p *ProjectileRGB) IsAlive() bool {
	return p.Alive
}

func (p *ProjectileRGB) GetObject() *resolv.Object {
	return p.Object
}
